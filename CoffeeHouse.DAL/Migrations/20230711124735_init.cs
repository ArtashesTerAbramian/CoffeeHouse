        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_beverage_size_translation_coffee_size_beverage_size_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_coffee_coffee_size_beverage_size_id",
                        column: x => x.beverage_size_id,
                        principalTable: "coffee_size",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "ix_coffee_beverage_size_id",
                table: "coffee",
                column: "beverage_size_id");

            migrationBuilder.CreateIndex(
                name: "ix_coffee_coffee_type_id_beverage_size_id",
                table: "coffee",
                columns: new[] { "coffee_type_id", "beverage_size_id" });
